System.register(['@angular/core', '../orders/shared/mock-orders', '../watchlist/mock-watchlist'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            SequanceGeneratorService = (function () {
                function SequanceGeneratorService() {
                }
                SequanceGeneratorService.prototype.getNextSequence = function (entity) {
                    var nextSequence = 0;
                    if (entity === 'order') {
                ...
                SequanceGeneratorService = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [])
                ], SequanceGeneratorService);
                return SequanceGeneratorService;
            }());
            exports_1("SequanceGeneratorService", SequanceGeneratorService);
        }
    }
});
//# sourceMappingURL=sequance-generator.service.js.map